...
import EmbedMatchDetail from "@/pages/embeds/EmbedMatchDetail";
import EmbedMatchWidget from "@/pages/embeds/EmbedMatchWidget";
import EmbedLeaderboardWidget from "@/pages/embeds/EmbedLeaderboardWidget";
...
function Router() {
  ...
  useEffect(() => {
    ...
    const hasSeenWelcome = localStorage.getItem('proace-welcome-seen');
    if (!hasSeenWelcome && !isEmbedRoute) {
  ...
  const handleWelcomeClose = () => {
    ...
    localStorage.setItem('proace-welcome-seen', 'true');
  };
    ...
    <>
      ...
      <main className={isEmbedRoute ? "" : (shouldHideNavbar ? "" : "min-h-screen")}>
        <Switch>
          ...
          <Route path="/embed/matches/:id" component={EmbedMatchDetail} />
          <Route path="/embed/widget/match/:id" component={EmbedMatchWidget} />
          <Route path="/embed/widget/leaderboard" component={EmbedLeaderboardWidget} />
      ...
      {!isEmbedRoute && <WelcomePopup isVisible={showWelcomePopup} onClose={handleWelcomeClose} />}
    </>
  );
}
